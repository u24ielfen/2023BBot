...
public class MidCone extends CommandBase {
  ...
  double time;
  public MidCone(TelescopicArm m_arm, Intake m_intake, Swerve s_Swerve, double time) {
    this.m_arm = m_arm;
    this.time = time;
  ...
  public Command getCommand(){
    ...
    //TODO: FIND VALUES
    return new SequentialCommandGroup(new pivotCommand(0.4117, 0.5, m_arm).alongWith
    (new winchCommand(-48.9, 0.6, m_arm).andThen(new intakeCommand(m_intake, "Out").
